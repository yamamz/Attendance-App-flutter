...
import 'package:class_room_app/core/widgets/example_widgets.dart';
...
Future<List<int>> generateDocument(PdfPageFormat format) async {
        ...
        Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
              Text('Parnella Charlesbois',
                  textScaleFactor: 2, style: Theme.of(context).defaultTextStyle.copyWith(fontWeight: FontWeight.bold)),
              Padding(padding: const EdgeInsets.only(top: 10)),
              Text('Electrotyper',
                  textScaleFactor: 1.2,
                  style: Theme.of(context).defaultTextStyle.copyWith(fontWeight: FontWeight.bold, color: green)),
              ...
              Row(
                  ...
                  children: <Widget>[
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                      Text('+1 403-721-6898'),
                      UrlText('p.charlesbois@yahoo.com', 'mailto:p.charlesbois@yahoo.com'),
                      UrlText('wholeprices.ca', 'https://wholeprices.ca'),
                    ]),
        ...
        children: <Widget>[
          ClipOval(
              child: Container(
                  ...
                  height: 100,
                  color: lightGreen,
                  child: profileImage == null ? Container() : Image(profileImage))),
